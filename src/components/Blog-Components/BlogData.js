...
{BlogData.map((item, index) => (
    ...
    <div className="blog bg-[#FFFBFA] hover:outline hover:outline-[#107243] outline-1 transition-all cursor-pointer p-6 flex flex-col items-start gap-4 relative rounded-3xl hover:shadow hover:shadow-slate-200 dark:shadow-gray-800 overflow-hidden">
