...
const AddCustomRequirmentsForm = ({ onCloseForm }) =>{
    ...
    const handleRequirementFormSubmit = async (event) => {
        ...
        try {
            const response = await axiosInstense.post("api/v1/customRequirements", formData, 
            { 
    ...
    return(
        <>
        <div style={{padding:"0.75rem !important"}} className="formOutline bg-[#F2F5FF] h-screen overflow-auto rounded-2xl shadow-lg">
        <div className="flex items-center justify-between mb-8">
            <div className="md:text-2xl text-xl font-semibold">Add Custom Requirement</div>
            ...
            <div className=" bg-[#EBEBEB] formMidInner rounded-xl shadow-lg">
                ...
                {errorMessage && 
                  <div className="p-4 mb-4 w-full md:w-[26rem] text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                        ...
                        <div className="mb-4 md:text-2xl text-base font-bold">Your Info</div>
                            <div className="mb-4">
                                <label class="form-label block text-xl">Your Name <sapn className="text-red-700">*</sapn></label>
                                <input name="name" type="text" class="w-full bg-[#E3E3E3] md:w-[26rem] h-[4rem] outline-none border-none rounded-lg px-2 py-2" />
                            </div>
                            <div className="mb-4">
                                <label class="form-label block text-xl">Your Phone Number <sapn className="text-red-700">*</sapn></label>
                                <input name="phoneNumber" type="text" class="w-full bg-[#E3E3E3] md:w-[26rem] h-[4rem] outline-none border-none rounded-lg px-2 py-2" />
                            </div>
                            <div className="mb-4 md:text-2xl text-base font-bold">Requirements</div>
                            <div className="mb-4">
                            ...
                            <label class="block text-xl">Applied For</label>
                                <select name="category" class="w-full bg-[#E3E3E3] md:w-[26rem] h-[4rem] outline-none border-none rounded-lg px-2 py-2">
                            ...
                            <label class="block text-xl">Experience</label>
                                ...
                                <select name="experience" class="w-full bg-[#E3E3E3] md:w-[26rem] h-[4rem] outline-none border-none rounded-lg px-2 py-2">
                            ...
                            <div>
                                <div class="mb-4">
                                    <button className="w-full flex items-center justify-center text-sm font-semibold bg-[#107243] text-white md:w-[26rem] h-[4rem] outline-none border-none rounded-lg px-2 py-2">
                                      {spinningLoader && <img className="w-8" src="https://i.gifer.com/origin/34/34338d26023e5515f6cc8969aa027bca.gif" alt="spinning Loader"/>}
