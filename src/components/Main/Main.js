        ...
        <>
            <section style={{backgroundColor:'#F2F5FF'}} className="dark:bg-gray-900">
                <div className="grid py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 container">
                    ...
                    <p style={{color: "var(--maincolors-button, #031D92)"}} className="max-w-2xl mb-6 font-bold text-2xl lg:text-4xl lg:mb-8 md:text-5xl xl:text-6xl">
                    {t('section.subtitle3')}
                    </p>
                    <p style={{color: "var(--neutral-700, #5F5F5F)"}} className="max-w-2xl mb-6 font-normal lg:mb-8 text-sm md:text-lg lg:text-xl">
                    ...
                    <img loading="lazy" style={imageStyle} src={Image} alt="Professional housemaid in uniform and she is Ready for diligently cleaning, organizing, and well-maintaining to your home" />
