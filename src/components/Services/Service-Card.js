  ...
  return (
    <>
      <Link to={props.address} className="h-full">
        <div
          style={{ height }}
          className="rounded-lg min-h-[30rem] flex flex-col items-start justify-between bg-[#FFFBFA] md:my-0 cursor-pointer relative overflow-hidden hover:shadow-md p-6 hover:outline hover:outline-[#107243] outline-1 transition-all"
        >
          <img
            loading="lazy"
          ...
          <div className="service-detail mt-2 md:text-start flex flex-col justify-between">
            ...
            <div className="seeProfileBtn text-center">
              <Link to={props.address}>
                <button
                  style={{ border: "1px solid #28BB76", color: "#28BB76" }}
                  className="rounded-md py-2 hover:bg-[#28BB76] hover:bg-opacity-30 active:bg-opacity-50 transition-all w-full mx-auto md:w-full text-center text-xs"
                >
