    ...
    return(
        <>
            <section className="py-10">
                <div className="grid rounded-3xl py-10 lg:gap-8 xl:gap-0 lg:grid-cols-12 container lg:bg-[#FFFBFA]">
                    ...
                    {props.buttonTxt && <span>
                        <Link to="/contact" className="font-medium text-center rounded-lg">
                            <ButtonEl color="#FFFBFA" bgColor="#107243" buttonTxt={props.buttonTxt}  px={3} py={1}/>
                        </Link>
                    </span>}
                    ...
                    <img loading="lazy" style={imageStyle} src={mainImage} alt="A cheerful Nepali domestic worker in a white shirt holding a cleaning kit in one hand and wearing yellow gloves in the other, smiling." />
